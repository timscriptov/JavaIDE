...
import com.android.lib.io.StringWriterOutputStream;
import com.duy.aapt.Aapt;
...
//===================================================================
	{
		...
		try
		{
			...
			ecjMain = new org.eclipse.jdt.internal.compiler.batch.Main(new PrintWriter(System.out), new PrintWriter(System.err), false/*noSystemExit*/, null/*options*/, null);
